...
public class ArithmeticCoding {
    ...
    public static Triple<BigInteger, Integer, Freq> encode(String str, Long radix) {
    ...
    public static String decode(BigInteger num, long radix, int pwr, Freq freq) {
